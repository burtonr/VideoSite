namespace VideoLab.Web.Constants
{
    public static class ContentDeliveryNetwork
    {
        ...
        public static class Select2
        {
            ...
            public const string Select2Style = "//cdnjs.cloudflare.com/ajax/libs/select2/4.0.1/css/select2.min.css";
            public const string Select2Url = "//cdnjs.cloudflare.com/ajax/libs/select2/4.0.1/js/select2.min.js";
        }
    }
}